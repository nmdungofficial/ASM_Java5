            ...
            <div class="container d-flex flex-column align-items-center">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link"
                               href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=0">First</a>
                        </li>
                        <li class="page-item ">
                            <a class="page-link"
                               href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=${page.number-1}"
                               onclick="if (${page.number==0}){ return false; }">Previous</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link"
                               href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=${page.number+1}"
                               onclick="if (${page.number}==${page.totalPages-1}){ return false; }">Next</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link"
                               href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=${page.totalPages-1}">Last</a>
                        </li>
                    </ul>
                </nav>
                <span>Đang ở trang số ${page.number+1} trong ${page.totalPages} trang</span>
            </div>
        </div>
    </div>
</div>